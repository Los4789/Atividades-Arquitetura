...
module multiplier_datapath (
    ...
    alu_32 alu (
        .a   (product_reg[63:32]), // Pega exatamente a metade superior (32 bits)
        .b   (multiplicand_reg),   // Multiplicando (32 bits)
        .sum (alu_sum)             // Resultado da soma (33 bits, inclui o carry)
    );
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            product_reg[64:32] <= '0;
            product_reg[31:0] <= multiplier_in;
